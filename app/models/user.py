"""
User model - Unified user accounts for the entire application.
"""
...
class User(db.Model):
    """Model for user accounts (used for both expenses and games)."""

    # Keep table name for database compatibility
